...
map.getView().fit([2569336.213889, 5124828.697376, 3209603.278214, 5533442.227718], map.getSize());
    ...
    element: (() => {
        ...
        if (115 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Предтсавелнная карта отображает количественные значания численности населения и площадей кпрнейших горобов Болгарии';
            }
